...
writefile("LogFile.txt", "hazzy.wtf loading started...\n")
...
local Name = "hazzy.wtf";

local Directory = "hazzy.wtf";
...
local Fonts = {};
local ImageDirectory = "https://raw.githubusercontent.com/hazzmat-wtf/hazzy-utils/refs/heads/main/";
...
--local CustomImageOverwrite = loadstring(game:HttpGet('https://raw.githubusercontent.com/SimplexScout/hazzmat-fallen/refs/heads/main/customAssets.lua'))();
...
local Theme = {
	Accent = Color3.fromRGB(255, 102, 0),   -- Hazmat Orange (bright, main color)
	DarkAccent = Color3.fromRGB(204, 85, 0), -- Darker Hazmat Orange (secondary UI elements)
	AccentedHighlight = Color3.fromRGB(153, 64, 0), -- Deep shade for highlights/shadows
};
...
LPH_NO_VIRTUALIZE(function() --// Not that important 
      ...
      function Library:CreateLoader(Data)
            ...
            do --// Components
                  ...
                  Components["HazzyLogo"] = Globals:Instance("ImageLabel", {
                        Image = Library.LogoImage,
                        AnchorPoint = Vector2.new(0, 0.5),
                        BackgroundColor3 = Color3.fromRGB(255, 255, 255),
                        BackgroundTransparency = 1,
                  ...
                  Components["HazzyTitle"] = Globals:Instance("TextLabel", {
            ...
            function Loader:SetStage(stage)
                  Components["ProgressStage"].Text = "hazzy.wtf | " .. stage
            end
...
LPH_JIT_MAX(function() --// UI Setup
	local Pages = {
		...
		ESP = Window:Tab({
            ...
            Media = Window:Tab({
			Name = "Media",
			Image = GetImage("MediaImage"), -- "rbxassetid://13321848320"
		}),
	...
	-- 
      ...
      local MediaCategories = {
		Chat = Pages.Media:Category({ Name = "Chat" }),
            Camera = Pages.Media:Category({ Name = "Camera" }),
	};

      local MessageTypes = MediaCategories.Chat:Section({
            Name = "Message Types",
            Side = "Left"
      })
	...
	local Flight = MiscCategories.Movement:Section({
      ...
      local Noclip = MiscCategories.Movement:Section({
		Name = "Noclip",
		Side = "Left"
	});
	...
	task.wait(2)
      ...
      Watermark:SetText("hazzy.wtf - Fallen Survival")
		...
		if Library.Flags.Hitmarkers.Value then
			...
			if HitMaterial == Enum.Material.Plastic then 
				Visuals.CreateHitmarker(HitPart, HitPos);
                        ...
                        if Humanoid then
                              local killedPlayerName = HitPart.Parent.Name
                              local Health = Humanoid.Health
                              
                              if Health < 3 then
                                    if Library.Flags.SendKillMessage.Value then
                                          local msgToSend = string.format("%s just got killed with hazzy.wtf | Buy today $2.00 @ hazzy.wtf", killedPlayerName)
